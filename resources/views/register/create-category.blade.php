...
@section('content')
  <div class="max-w-xl mx-auto">
    ...
    <form action="{{ route('categories.store') }}" method="POST" class="space-y-6 bg-white p-8 rounded-lg shadow-lg">
      @csrf

      <h2 class="text-lg font-semibold text-gray-900">Informações do Categoria</h2>
      <p class="text-sm text-gray-500">Preencha o nome do Categoria abaixo.</p>
